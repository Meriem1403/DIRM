...
CREATE TABLE personne_abord (id INT AUTO_INCREMENT NOT NULL, declaration_chantier_id INT NOT NULL, equipage INT DEFAULT NULL, passagers INT DEFAULT NULL, personnes INT DEFAULT NULL, INDEX IDX_F3E3B529F8F0B84A (declaration_chantier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;

-- Migration Version20250710095921
ALTER TABLE declaration_chantier ADD architecte_mail VARCHAR(255) DEFAULT NULL, ADD nb_equipage INT DEFAULT NULL, ADD nb_passagers INT DEFAULT NULL, ADD nb_personnel_special INT DEFAULT NULL, ADD nom_chantier VARCHAR(100) DEFAULT NULL;
