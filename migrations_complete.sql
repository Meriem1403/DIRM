...
CREATE TABLE declaration_chantier (id INT AUTO_INCREMENT NOT NULL, valide_par_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(20) NOT NULL, qualite_declarant VARCHAR(50) NOT NULL, type_demande VARCHAR(50) NOT NULL, type_projet VARCHAR(50) NOT NULL, activites JSON NOT NULL, nom_navire VARCHAR(150) NOT NULL, pavillon_origine VARCHAR(150) DEFAULT NULL, quartier_immatriculation VARCHAR(150) NOT NULL, jauge DOUBLE PRECISION NOT NULL, longueur DOUBLE PRECISION NOT NULL, largeur DOUBLE PRECISION NOT NULL, propulsion VARCHAR(50) NOT NULL, puissance_kw DOUBLE PRECISION NOT NULL, vitesse VARCHAR(50) NOT NULL, materiau VARCHAR(100) NOT NULL, date_pose_quille DATE NOT NULL, chantier_naval VARCHAR(255) NOT NULL, architecte_naval VARCHAR(255) DEFAULT NULL, organisme_classe VARCHAR(255) DEFAULT NULL, categorie_conception VARCHAR(50) DEFAULT NULL, numero_serie VARCHAR(100) DEFAULT NULL, numero_coque VARCHAR(100) DEFAULT NULL, modules_evaluation VARCHAR(255) DEFAULT NULL, organisme_notifie VARCHAR(100) DEFAULT NULL, autre_nom VARCHAR(100) DEFAULT NULL, autre_prenom VARCHAR(100) DEFAULT NULL, autre_qualite VARCHAR(50) DEFAULT NULL, autre_telephone VARCHAR(100) DEFAULT NULL, statut VARCHAR(50) NOT NULL, date_soumission DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', date_validation DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', recepisse_path VARCHAR(255) DEFAULT NULL, INDEX IDX_90B9C4D86AF12ED9 (valide_par_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
